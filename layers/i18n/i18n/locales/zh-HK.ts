export default {
  ...
  admin: {
    ...
    pages: {
      userProfiles: {
        title: "用戶子庫範圍",
        explainer: "限制每位用戶在收貨及揀貨清單中看到的子庫。未設範圍即不設限制。",
        searchPlaceholder: "搜尋用戶…",
        username: "用戶名",
        displayName: "顯示名稱",
        groups: "用戶群組",
      ...
      supplierProfile: {
        title: "供應商資料 — {code}",
        namePlaceholder: "本地顯示名稱（可留空）",
        labelCodeType: "標籤條碼類型",
        notSpecified: "未指定",
        other: "其他…",
        otherTypePlaceholder: "例如 Code 39",
        labelCodeTypeHint: "此供應商標籤上印刷的條碼種類。",
        qtyFormat: "數量格式",
        qtyPlain: "普通數字",
        qtyKoa: "KOA 格式 — 最後一位代表零的個數（例如 253 → 25,000）",
        scanTemplate: "掃描模板",
        sampleScan: "掃描範例",
        samplePlaceholder: "掃描或貼上此供應商的真實標籤，例如 :RK73H1JTTD1002F:S1:14:X:L2601A:602:NAME",
        sampleHint: "使用 PDA 掃描器，或從真實標籤複製原始碼。",
        format: "格式",
        modeDelimited: "以分隔字元拆分",
        modeFixed: "固定位置",
        modeAdvanced: "進階（直接編輯規則）",
        separator: "分隔字元",
        labelEachPiece: "為每段標記欄位",
        emptyPiece: "（空）",
        fieldsByPosition: "按位置劃分欄位",
        charsRange: "字元 {start}–{end}",
        start: "起始",
        length: "長度",
        add: "新增",
        removeField: "移除欄位",
        positionsHint: "位置為以 0 起始的字元偏移。",
        pattern: "規則（正規表達式）",
        namedGroupsHint: "具名群組：itemId（必填）、qty、lotCode、dateCode、coo、cow、serialNo。",
        rebuildFromSample: "從掃描範例重新建立",
        parsedFromSample: "從範例解析的結果",
        generatedPattern: "產生的規則：",
        koaFormat: "KOA 格式",
        testMore: "測試更多掃描",
        optional: "（可選）",
        testPlaceholder: "貼上更多真實標籤，每行一個",
        saveProfile: "儲存資料",
        roles: {
          itemId: "料號（必填）",
          qty: "數量",
        ...
        errors: {
          enterPattern: "請輸入規則。",
          invalidRegex: "此規則不是有效的正規表達式。",
          pasteSampleFirst: "請先貼上掃描範例。",
          addOneField: "請至少新增一個欄位。",
          markOneItemId: "請將其中一段標記為料號。",
          onlyOneItemId: "只有一段可以是料號。",
          sampleNoMatch: "範例與模板不符。",
          sampleNoItemId: "模板必須能從範例中擷取料號。",
          noMatch: "與模板不符。",
      ...
      pickingOrders: {
        ...
        pickingListError: "揀貨清單下載失敗",
        allocateAll: "全部分配",
        allocateAllConfirm: "重新分配所有未完成的揀貨單？正在 PDA 上操作的訂單（工作鎖定）會被略過。",
        reallocate: "重新分配",
        reallocateConfirm: "重新分配訂單 {orderNo}？",
        ...
        overrideTarget: "新狀態",
        overrideTargetPlaceholder: "選擇狀態…",
        overrideReason: "原因（選填）",
        overrideReasonPlaceholder: "為何要更改狀態？",
        overrideReopenWarning: "此操作會重新開啟已完成／已出貨的訂單 — 訂單會重新進入分配需求，而 PDA 上持有的工作鎖會被解除。",
        overrideFailed: "以下訂單的狀態覆寫失敗：{orders}",
        ...
        removeAllocationConfirm: "移除 {partNo} 的此項分配（{qty} 件）？系統會在背景重新計算分配。",
        searchAvailability: "可用量",
        availabilityTitle: "零件可用量 — {partNo}",
        availabilityContext: "本訂單：org {org} / 子庫 {subInventory}（相符的列會標亮）。",
        availabilityStock: "庫存批次",
      ...
      receiving: {
        ...
        downloadShipper: "下載出貨單",
        downloadFinishedShipper: "下載已完成出貨單",
        confirmInHand: "確認收貨",
        confirmInHandConfirm: "確認訂單 {batchNo} 已到貨？此操作會將訂單標記為已收貨，並將每行實收數量設為應收數量。",
        shipperError: "出貨單下載失敗",
        reallocate: "重新分配",
        reallocateConfirm: "重新分配收貨單 {batchNo} 的貨品？",
        reallocateNotInHand: "訂單確認收貨後才能重新分配。",
        reallocateNotFound: "找不到收貨單 — 可能已被移除。",
        overrideStatus: "覆寫狀態",
        overrideStatusSelected: "設定狀態（{n}）",
        overrideModalTitleSingle: "覆寫狀態 — {orderNo}",
        overrideModalTitleBatch: "覆寫狀態 — {n} 張訂單",
        ...
        overrideReason: "原因（選填）",
        overrideReasonPlaceholder: "為何要更改狀態？",
        overrideReopenWarning: "此操作會重新開啟已清貨的收貨單 — 其庫存會重新進入分配供應。",
        overrideBackwardWarning: "此操作會把已收貨的訂單退回收貨前狀態 — 已收數量及月台台帳記錄會保留不變。",
        overrideFailed: "以下訂單的狀態覆寫失敗：{orders}",
        ...
        dateCode: "Date Code",
        noInvoices: "此收貨單暫無發票。",
        invoiceFilterPlaceholder: "按發票號 / 零件編號 / PO / 箱號篩選…",
        ...
        clearSelection: "清除選擇",
        selectAll: "全選",
        editModalTitleSingle: "編輯項目 — {partNo}",
        editModalTitleBatch: "批次編輯 — {count} 個項目",
        lotCode: "Lot Code",
        coo: "COO",
        cow: "COW",
        leaveUnchangedHint: "留空的欄位會保留各項目原本的値。",
        allocate: "分配",
        manualBadge: "人手",
        ...
        searchContext: "此項目：org {org} / 子庫 {subInventory}。",
        searchDemand: "相關揀貨訂單",
        searchStock: "相關庫存"
      },
      auditLog: {
      ...
      stockSearch: {
        ...
        noLots: "暫無庫存批次。",
        summaryItems: "物料項目",
        summaryOnHandQty: "現有數量",
        summaryAllocatedQty: "已分配",
        summaryAvailableQty: "可用",
        summaryLots: "批次",
        summaryShelves: "使用中貨架",
        summaryLastUpdate: "最近庫存更新",
        summaryOutdatedItems: "過期物料（超過 {years} 年）",
      ...
      flowConfig: {
        ...
        stockSection: "庫存",
        outdatedStockYears: "過期門檻（年）",
        outdatedStockYearsHint: "批次日期代碼（WWYY）早於此年數的物料，會在庫存查詢概要中計為過期。",
        outdatedStockYearsInvalid: "過期門檻必須是正整數（年）。",
        rulesSection: "收貨子庫存規則（確認到貨）",
        ruleOrgIds: "Org ID（例如 140, 143）",
        rulePoPattern: "PO 模式（例如 319*、11*W）",
        ruleSubInventory: "子庫存",
        groupDefault: "預設值（無模式命中時）",
        groupDefaultHint: "當 Org 命中本分組但所有 PO 模式都不匹配時寫入的子庫存。留空 = 不修改該項目。",
        addPattern: "新增模式",
        addGroup: "新增 Org 分組",
        removeRule: "刪除",
        removeGroup: "刪除分組",
        rulesHint: "在確認收貨到貨時、分配計算之前應用。項目先進入包含其 Org ID 的分組，然後命中的第一條 PO 模式生效；全部不命中時使用分組預設值。PO 模式為萬用字元匹配：* 匹配任意字符，其餘字符按字面匹配 —— 319* 匹配前綴、*W 匹配後綴、11*W 同時限定前後綴。只會寫入子庫存，不會修改項目的 Org。Org 不在任何分組中的項目保持原值。",
        rulesInvalid: "每個分組都需要以逗號分隔的整數 Org ID；每行模式都需要非空的 PO 模式和子庫存代碼。",
        fromOrgsSection: "揀貨調撥規則（from_subinventory → Org）",
        ruleFromSubinventories: "from_subinventory 代碼（逗號分隔，例如 SZHK2, GZHK2）",
      ...
      displayConfig: {
        ...
        template: "日期代碼顯示模板",
        templateHint: "佔位符：[date_code] 日期代碼、[lot_code] Lot 編號、[coo] COO、[cow] COW、[coo_short]／[cow_short] COO／COW 短代碼（在國家列表中按國家設定）。欄位為空時該佔位符顯示為空（不會留下多餘分隔符）；方括號以外的文字原樣顯示。套用位置：收貨單明細項目、揀貨單明細的分配及箱件欄。",
        ...
        roTemplateSection: "收貨單名稱模板",
        roTemplate: "收貨單名稱模板",
        roTemplateHint: "佔位符：[batch_no] 批次號、[invoice_no] 發票號碼（多張以逗號連接）、[supplier_code] 供應商代碼、[supplier_name] 供應商名稱、[delivery_date] 送貨日期（YYYY-MM-DD）、[date_code] 日期代碼。欄位為空時該佔位符顯示為空；若整個結果顯示為空，則改用批次號。套用位置：PDA 收貨列表及訂單標題、後台收貨列表及訂單明細標題。",
        roPreviewFull: "例子（批次 BATCH-20260921-01、發票 INV-100234 + INV-100235、供應商 Supplier Ltd、送貨 2026-09-21、日期代碼 3626）",
        roPreviewFallback: "例子（無發票／供應商／日期 — 回退顯示批次號）",
        roPlaceholderLabels: {
          batch_no: "批次號",
          invoice_no: "發票號碼",
          invoice_no_first: "第一張發票號碼",
          supplier_code: "供應商代碼",
          supplier_name: "供應商名稱",
          delivery_date: "送貨日期",
          date_code: "日期代碼"
        ...
        pdaTitle: "標題模板",
        pdaMeta: "副標題模板",
        pdaHint: "佔位符顯示該行欄位；欄位為空時該佔位符顯示為空，方括號以外的文字原樣顯示。標題結果為空時改用預設標題（行不會顯示空白）；副標題結果為空時整行隱藏。日期顯示 YYYY-MM-DD，時間戳顯示 YYYY-MM-DD HH:mm；收貨的 [name] 為上方收貨單名稱模板產生的訂單名稱。",
        pdaPreviewTitleFull: "標題（完整示例行）",
        pdaPreviewMetaFull: "副標題（完整示例行）",
        pdaPreviewTitlePartial: "標題（欄位缺失 — 回退）",
        pdaPreviewMetaPartial: "副標題（欄位缺失 — 為空時隱藏）",
        pdaFieldLabels: {
          name: "訂單名稱",
          batch_no: "批次號",
          invoice_no: "發票號碼",
          ...
          invoice_count: "發票數量",
          item_count: "項目數量",
          remaining_items: "未完成項目",
          pending_picking_orders: "待執貨單數",
          order_no: "訂單號",
          allocation_status: "分配狀態",
          customer_code: "客戶代碼",
          po_no: "PO 號",
          ship_to: "收貨地",
          total_qty: "總數量",
          ...
          verified_by: "核對人",
          verified_at: "核對時間",
          shipping_box_id: "運輸箱號",
          box_status: "箱狀態",
          order_nos: "訂單號",
          destination_country: "目的地國家",
          package_count: "箱件數量",
          verify_verified_count: "已核對箱件",
          verified_count: "已核對數量"
        },
        saved: "已儲存。"
      },
      labelPrintRules: {
