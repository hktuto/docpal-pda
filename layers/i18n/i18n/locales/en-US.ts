export default {
  ...
  errors: {
    ...
    measuring_task_exists: "A measuring task already exists for this order",
    ...
    different_picking_orders: "Package and box belong to different picking orders",
  ...
  admin: {
    ...
    pages: {
      ...
      shipping: {
        ...
        boxes: "Boxes",
        completed: "Completed",
        boxesClosed: "{closed} / {total} closed",
        none: "No completed shipping orders.",
        detailTitle: "Shipping Order {orderNo}",
        ...
        verified: "Verified",
        emptyBox: "Empty box.",
        noBoxes: "No boxes on this order."
      },
      stockSearch: {
        title: "Stock Search",
        supplier: "Supplier",
