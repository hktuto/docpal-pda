  ...
  admin: {
    ...
    pages: {
      ...
      supplierProfile: {
        ...
        namePlaceholder: "local display name (optional)",
        labelCodeType: "Label code type",
        notSpecified: "Not specified",
        other: "Other…",
        otherTypePlaceholder: "e.g. Code 39",
        labelCodeTypeHint: "The kind of barcode printed on this supplier's labels.",
        qtyFormat: "Quantity format",
        qtyPlain: "Plain number",
        qtyKoa: "KOA style — last digit counts zeros (e.g. 253 → 25,000)",
        ...
        sampleHint: "Use the PDA scanner or copy the raw code from a real label.",
        format: "Format",
        modeDelimited: "Separated by a character",
        modeFixed: "Fixed positions",
        modeAdvanced: "Advanced (edit pattern directly)",
        separator: "Separator",
        labelEachPiece: "Label each piece",
        emptyPiece: "(empty)",
        fieldsByPosition: "Fields by position",
        charsRange: "chars {start}–{end}",
        start: "start",
        length: "length",
        add: "Add",
        removeField: "Remove field",
        positionsHint: "Positions are 0-based character offsets on the sample.",
        pattern: "Pattern (regular expression)",
        namedGroupsHint: "Named groups: itemId (required), qty, lotCode, dateCode, coo, cow, serialNo.",
        rebuildFromSample: "Rebuild from a sample scan",
        parsedFromSample: "Parsed from the sample",
        generatedPattern: "Generated pattern:",
        koaFormat: "KOA format",
        testMore: "Test more scans",
        optional: "(optional)",
        testPlaceholder: "Paste more real labels, one per line",
        saveProfile: "Save profile",
        roles: {
          itemId: "Part number (required)",
          qty: "Quantity",
          lotCode: "Lot code",
          dateCode: "Date code",
          coo: "Country of origin",
          cow: "Country of warehousing",
          serialNo: "Serial number",
          ignore: "Ignore this piece"
        },
        preview: {
          itemId: "Part number",
          qty: "Quantity",
        ...
        errors: {
          ...
          invalidRegex: "This pattern is not a valid regular expression.",
          pasteSampleFirst: "Paste a sample scan first.",
          addOneField: "Add at least one field.",
          markOneItemId: "Mark exactly one piece as Part number.",
          onlyOneItemId: "Only one piece can be the Part number.",
          sampleNoMatch: "The sample does not match the template.",
          sampleNoItemId: "The template must capture a Part number from the sample.",
      ...
      pickingOrders: {
        ...
        pickingListError: "Picking list download failed",
        allocateAll: "Allocate all",
        allocateAllConfirm: "Re-run allocation for ALL open picking orders? Orders currently open on a PDA (work-locked) are skipped.",
        reallocate: "Re-allocate",
        reallocateConfirm: "Re-run allocation for order {orderNo}?",
        ...
        overrideTargetPlaceholder: "Select status…",
        overrideReason: "Reason (optional)",
        overrideReasonPlaceholder: "Why is the status being changed?",
        overrideReopenWarning: "This reopens a finished/shipped order — it re-enters allocation demand and a work lock held on a PDA is released.",
        overrideFailed: "Status override failed for: {orders}",
        ...
        removeAllocationConfirm: "Remove this allocation of {qty} × {partNo}? Allocation will recompute in the background.",
        searchAvailability: "Availability",
        availabilityTitle: "Part availability — {partNo}",
        availabilityContext: "This order: org {org} / sub-inventory {subInventory} (matching rows highlighted).",
        availabilityStock: "Stock lots",
      ...
      receiving: {
        ...
        downloadFinishedShipper: "Download finished shipper",
        confirmInHand: "Confirm In-hand",
        confirmInHandConfirm: "Confirm full receipt of order {batchNo}? This marks the order in-hand and sets received qty = expected on every line.",
        shipperError: "Shipper download failed",
        reallocate: "Re-allocate",
        reallocateConfirm: "Re-run allocation for receiving order {batchNo}'s parts?",
        reallocateNotInHand: "Re-allocation is only available once the order is in-hand.",
        reallocateNotFound: "Receiving order not found — it may have been removed.",
        overrideStatus: "Override status",
        overrideStatusSelected: "Set status ({n})",
        overrideModalTitleSingle: "Override status — {orderNo}",
        overrideModalTitleBatch: "Override status — {n} orders",
        ...
        overrideReason: "Reason (optional)",
        overrideReasonPlaceholder: "Why is the status being changed?",
        overrideReopenWarning: "This reopens a clear order — its stock re-enters allocation supply.",
        overrideBackwardWarning: "This rolls a received order back to pre-receipt — received quantities and dock ledger rows are kept as-is.",
        overrideFailed: "Status override failed for: {orders}",
        ...
        invoiceFilterPlaceholder: "Filter invoices by no / part no / PO / ctn no…",
        ...
        selectAll: "Select all",
        editModalTitleSingle: "Edit item — {partNo}",
        editModalTitleBatch: "Batch edit — {count} items",
        lotCode: "Lot Code",
        coo: "COO",
        cow: "COW",
        leaveUnchangedHint: "Leave a field blank to keep each item's current value.",
        allocate: "Allocate",
        manualBadge: "manual",
        ...
        searchContext: "This item: org {org} / sub-inventory {subInventory}.",
      ...
      stockSearch: {
        ...
        allOrgs: "All orgs",
        subInventory: "Sub-inventory",
        allSubInventories: "All sub-inventories",
        zone: "Zone",
        allZones: "All zones",
        ...
        summaryItems: "Items",
        summaryOnHandQty: "On-hand qty",
        summaryAllocatedQty: "Allocated",
        summaryAvailableQty: "Available",
        summaryLots: "Lots",
        summaryShelves: "Shelves in use",
        summaryLastUpdate: "Last stock update",
        summaryOutdatedItems: "Outdated items (> {years}y)",
      ...
      flowConfig: {
        ...
        stockSection: "Stock",
        outdatedStockYears: "Outdated threshold (years)",
        outdatedStockYearsHint: "Items whose lot date code (WWYY) is older than this many years count as outdated in the stock-search summary.",
        outdatedStockYearsInvalid: "Outdated threshold must be a positive integer (years).",
        rulesSection: "Receiving sub-inventory rules (confirm arrival)",
        ruleOrgIds: "Org IDs (e.g. 140, 143)",
        rulePoPattern: "PO pattern (e.g. 319*, 11*W)",
        ruleSubInventory: "Sub-inventory",
        groupDefault: "Default (no pattern match)",
        groupDefaultHint: "Sub-inventory stamped when the org matches this group but no PO pattern does. Empty = leave the item unchanged.",
        addPattern: "Add pattern",
        addGroup: "Add org group",
        removeRule: "Remove",
        removeGroup: "Remove group",
        rulesHint: "Applied when a receiving arrival is confirmed, before allocation runs. An item enters the group containing its org ID, then the first matching PO pattern wins; if none matches, the group's default is used. The PO pattern is a glob: * matches any characters, everything else is literal — 319* prefix, *W suffix, 11*W both. Only the sub-inventory is stamped — the item's org is never changed. Items whose org is in no group keep their value.",
        rulesInvalid: "Every group needs comma-separated integer org IDs, and every pattern row needs a non-empty PO pattern and sub-inventory code.",
        fromOrgsSection: "Picking transfer rules (from_subinventory → org)",
        ruleFromSubinventories: "from_subinventory codes (e.g. SZHK2, GZHK2)",
      ...
      displayConfig: {
        ...
        pdaTitle: "Title template",
        pdaMeta: "Meta template",
        pdaHint: "Placeholders render the row's fields; a placeholder whose field is empty renders as empty, and text outside brackets shows literally. If the title renders empty the default title is used instead (a row never shows blank); if the meta renders empty the meta line is hidden. Dates render YYYY-MM-DD, timestamps YYYY-MM-DD HH:mm; the receiving [name] is the order name from the receiving order name template above.",
        pdaPreviewTitleFull: "Title (full sample row)",
        pdaPreviewMetaFull: "Meta (full sample row)",
        pdaPreviewTitlePartial: "Title (missing fields — fallback)",
        pdaPreviewMetaPartial: "Meta (missing fields — hidden when empty)",
        pdaFieldLabels: {
          name: "Order name",
          batch_no: "Batch no",
          invoice_no: "Invoice no(s)",
          ...
          pending_picking_orders: "Pending picking orders",
          order_no: "Order no",
          ...
          working_by_name: "Working by",
          sub_inventory_code: "Sub-inventory",
          ...
          order_nos: "Order no(s)",
          destination_country: "Destination country",
          package_count: "Package count",
          verify_verified_count: "Verified packages",
