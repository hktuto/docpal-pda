...
>;
  ...
  const pendingReceivingOrders = [
    {
      id: uuid(),
      refNo: "PENDING-001",
      supplierId: supplierByCode.DAITO.id,
    ...
    },
    {
      id: uuid(),
      refNo: "PENDING-002",
      supplierId: supplierByCode.MMC.id,
    ...
    },
    {
      id: uuid(),
      refNo: "PENDING-003",
      supplierId: supplierByCode.NDK.id,
  ...
  await db.insert(schema.receivingOrders).values([wclReceivingOrder, ...pendingReceivingOrders]);
...
const pendingInvoiceRecords = [
  { id: uuid(), receivingOrderId: pendingReceivingOrders[0].id, invoiceNo: 'PENDING-001-W-01', supplierId: supplierByCode.DAITO.id },
  { id: uuid(), receivingOrderId: pendingReceivingOrders[1].id, invoiceNo: 'PENDING-002-W-01', supplierId: supplierByCode.MMC.id },
  { id: uuid(), receivingOrderId: pendingReceivingOrders[2].id, invoiceNo: 'PENDING-003-W-01', supplierId: supplierByCode.NDK.id },
  { id: uuid(), receivingOrderId: pendingReceivingOrders[3].id, invoiceNo: 'PENDING-004-W-01', supplierId: supplierByCode.TE.id },
] as const;
...
>;
  await db.insert(schema.receivingInvoices).values([...wclInvoiceRecords, ...pendingInvoiceRecords]);
...
const pendingReceivingInvoiceItemRecords = [
  // PENDING-001
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[0].id, partId: wclPartByNo['HV732HTTE1004F'].id, poNo: 'PO-P001-1', poLine: '1', qty: 2000, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9001', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[0].id, partId: wclPartByNo['HV732HTTE1503F'].id, poNo: 'PO-P001-2', poLine: '2', qty: 3000, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9002', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  // PENDING-002
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[1].id, partId: wclPartByNo['RK73B1ETTP102J'].id, poNo: 'PO-P002-1', poLine: '1', qty: 1500, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9003', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[1].id, partId: wclPartByNo['RK73B1ETTP105J'].id, poNo: 'PO-P002-2', poLine: '2', qty: 2500, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9004', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  // PENDING-003
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[2].id, partId: wclPartByNo['RK73B1ETTP330J'].id, poNo: 'PO-P003-1', poLine: '1', qty: 1800, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9005', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[2].id, partId: wclPartByNo['RK73B1ETTP512J'].id, poNo: 'PO-P003-2', poLine: '2', qty: 2200, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9006', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  // PENDING-004
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[3].id, partId: wclPartByNo['RK73B1ETTP5R1J'].id, poNo: 'PO-P004-1', poLine: '1', qty: 1200, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9007', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
  { id: uuid(), receivingInvoiceId: pendingInvoiceRecords[3].id, partId: wclPartByNo['RK73B1HTTC103J'].id, poNo: 'PO-P004-2', poLine: '2', qty: 3200, receivedQty: 0, pickedQty: 0, putAwayQty: 0, boxId: 'H9008', dateCode: '', lotCode: '', coo: 'CN', cow: 'USA' },
] as const;

  await db.insert(schema.receivingInvoiceItems).values([...wclReceivingInvoiceItemRecords, ...pendingReceivingInvoiceItemRecords]);
