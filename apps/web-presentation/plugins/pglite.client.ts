...
export default defineNuxtPlugin(async () => {
  ...
  // Persist the mock database in IndexedDB so reloads keep the seeded data
  // (including stable demo user ids for auth).
  const pg = new PGlite("idb://warehouse-demo-pglite");
