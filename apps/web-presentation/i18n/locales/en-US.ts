export default {
  ...
  goodsVerify: {
    title: "Goods Verify",
    searchPlaceholder: "Search task ref or status…",
    ...
    task: {
      ...
      shelvesTitle: "Shelves to verify",
      dueDate: "Due: {date}",
      shelves: "{count} shelves",
      boxes: "{count} boxes",
      progress: "{verified} / {total} done"
    }
  },
  measuring: {
    title: "Measuring",
  ...
  errors: {
    ...
    receiving_order_not_in_hand: "Receiving order is not in hand",
    ...
    goods_verify_task_not_found: "Verification task not found",
    ...
    receiving_item_mismatch_not_found: "Mismatch record not found",
    only_pending_mismatch_can_be_edited: "Only pending mismatches can be edited",
    only_reporter_can_edit_mismatch: "Only the reporter can edit this mismatch",
    only_pending_mismatch_can_be_confirmed: "Only pending mismatches can be confirmed",
    reporter_cannot_confirm_own_mismatch: "The reporter cannot confirm their own mismatch",
    only_pending_mismatch_can_be_cancelled: "Only pending mismatches can be cancelled",
    reporter_cannot_cancel_own_mismatch: "The reporter cannot cancel their own mismatch",
