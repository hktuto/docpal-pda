export default {
  ...
  errors: {
    ...
    receiving_order_not_in_hand: "收货单不是已收货状态",
    ...
    pending_mismatch_already_exists: "此项已存在待确认的差异",
    receiving_item_mismatch_not_found: "找不到差异记录",
    only_pending_mismatch_can_be_edited: "只有待确认的差异可以编辑",
    only_reporter_can_edit_mismatch: "只有报告人可以编辑此差异",
    only_pending_mismatch_can_be_confirmed: "只有待确认的差异可以确认",
    reporter_cannot_confirm_own_mismatch: "报告人不能确认自己的差异",
    only_pending_mismatch_can_be_cancelled: "只有待确认的差异可以取消",
    reporter_cannot_cancel_own_mismatch: "报告人不能取消自己的差异",
    receiving_order_already_status: "收货单已为 {status} 状态",
    allocation_not_found: "未找到分配",
    allocation_not_against_receiving_item: "分配未针对收货项",
    allocation_not_against_receiving_order: "分配未针对收货单",
  ...
  stockSearch: {
    ...
    filterSupplier: "供应商",
    filterItem: "物料",
    onlyWithInventory: "仅显示有库存",
    noResults: "未找到结果。",
    noItems: "该供应商暂无物料。",
    noInventory: "无库存",
    totalQty: "合计：{qty}",
    supplierCounts: "{withInventory} / {total} 项物料",
