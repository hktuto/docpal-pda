...
// Self-registers as the "shipper" default at module load.

import * as XLSX from "xlsx";
import { registerRenderer } from "../../registry.js";
import type { ShipperDocument, ShipperSlot } from "../model.js";

export function render(doc: ShipperDocument): { fileName: string; buffer: Buffer } {
...
registerRenderer("shipper", { render });
